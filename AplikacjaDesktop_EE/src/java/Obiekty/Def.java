...
public class Def {
    ...
    public final static byte LVL0 = (byte) 0x0;    // 00000000 - podstawowe menu (klient)
    ...
    public final static byte LVL4 = (byte) 0x8;    // 00001000 - dodawanie danych części (menu zaopatrzeniowca)
    ...
    public final static byte LVL9 = (byte) 0x80;   // 10000000 - menu adminstartora                                             
    ...
    public final static String O_A_USERD = "Dodaj użytkownika/dane osobowe";
}
